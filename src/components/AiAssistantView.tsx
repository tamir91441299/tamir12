...
import { Sparkles, Send, Bot, RefreshCw, Play, Film, MessageSquare, Flame, Lightbulb, Compass, Gamepad2 } from 'lucide-react';
...
export const AiAssistantView: React.FC<AiAssistantViewProps> = ({
  ...
  const [activeSubTab, setActiveSubTab] = useState<'ai' | 'game'>(initialSubTab);
    ...
    <div className="space-y-6 max-w-5xl mx-auto">
      ...
      <div className="bg-gradient-to-r from-cyan-950/80 via-zinc-900 to-purple-950/80 border border-cyan-500/40 rounded-3xl p-6 sm:p-8 shadow-2xl relative overflow-hidden">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 relative z-10">
          ...
          {/* Sub-tab buttons */}
          <div className="flex items-center bg-zinc-950/80 p-1.5 rounded-2xl border border-zinc-800 shrink-0 w-full md:w-auto">
            <button
      ...
      {activeSubTab === 'game' ? (
        <div className="bg-zinc-950/60 border border-zinc-800 rounded-3xl p-4 sm:p-6 shadow-2xl">
          <AnimeGuesser />
        </div>
      ) : (
        /* AI Assistant View */
