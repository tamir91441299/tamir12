                  ...
                  <div className="relative">
                    ...
                    {showSettingsMenu && (
                      <div className="absolute right-0 bottom-12 w-80 max-h-[85vh] overflow-y-auto bg-zinc-900/98 border border-zinc-750 rounded-2xl p-4 shadow-2xl space-y-3.5 z-50 text-xs text-zinc-200 backdrop-blur-2xl animate-in fade-in zoom-in-95 duration-150 custom-scrollbar">
                        ...
                        {/* Interactive Quality / Resolution Selector */}
                        <div className="border-t border-zinc-800 pt-2.5">
                          <div className="font-bold text-cyan-400 mb-1.5 flex items-center justify-between">
                            ...
                            <span className="text-[10px] text-cyan-300 font-bold">{activeQualityOption.label}</span>
                          </div>
                        ...
                        {/* Visual Enhancer Profile (HDR / Sharp detail) */}
                        <div className="border-t border-zinc-800 pt-2.5">
                          <div className="font-bold text-cyan-400 mb-1.5 flex items-center gap-1.5">
                            <Sparkles className="w-4 h-4" />
                            <span>Дүрс сайжруулагч (Color & Detail)</span>
                          </div>
                          <div className="grid grid-cols-3 gap-1.5 mt-1">
                            <button
                              type="button"
                              onClick={() => {
                                setColorProfile('vibrant_hdr');
                                setQualityNotice('💎 Vibrant HDR горим идэвхжлээ');
                                setTimeout(() => setQualityNotice(null), 2000);
                                resetControlsTimer();
                              }}
                              className={`py-1.5 px-2 rounded-xl text-center text-[11px] font-bold cursor-pointer transition-all ${
                                colorProfile === 'vibrant_hdr'
                            ...
                            <button
                              type="button"
                              onClick={() => {
                                setColorProfile('sharp_cinema');
                                setQualityNotice('⚡ Хурц Cinema горим идэвхжлээ');
                                setTimeout(() => setQualityNotice(null), 2000);
                                resetControlsTimer();
                              }}
                              className={`py-1.5 px-2 rounded-xl text-center text-[11px] font-bold cursor-pointer transition-all ${
                            ...
                            <button
                              type="button"
                              onClick={() => {
                                setColorProfile('standard');
                                setQualityNotice('🎬 Стандарт горим');
                                setTimeout(() => setQualityNotice(null), 2000);
                                resetControlsTimer();
                              }}
                              className={`py-1.5 px-2 rounded-xl text-center text-[11px] font-bold cursor-pointer transition-all ${
                        ...
                        <div className="border-t border-zinc-800 pt-2.5">
                          <div className="font-bold text-cyan-400 mb-1.5 flex items-center gap-1.5">
                            ...
                            <span>Сервер (Streaming Node)</span>
                          </div>
                          <div className="grid grid-cols-2 gap-1.5 mt-1">
                            <button
                              type="button"
                              onClick={() => {
                                handleServerChange('direct');
                                resetControlsTimer();
                              }}
                              className={`py-1.5 px-2 rounded-xl text-center text-xs font-bold cursor-pointer transition-all flex items-center justify-center gap-1.5 ${
                                serverMode === 'direct'
                                  ? 'bg-cyan-500 text-black font-black shadow'
                                  : 'bg-zinc-800 text-zinc-300 hover:bg-zinc-700'
                              }`}
                            >
                              ...
                              <span>Шууд 1080p HD</span>
                            </button>
                            <button
                              type="button"
                              onClick={() => {
                                handleServerChange('embed');
                                resetControlsTimer();
                              }}
                              className={`py-1.5 px-2 rounded-xl text-center text-xs font-bold cursor-pointer transition-all flex items-center justify-center gap-1.5 ${
                                serverMode === 'embed'
