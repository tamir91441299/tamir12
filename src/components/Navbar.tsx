        ...
        <div className="flex items-center gap-2 sm:gap-2.5 text-zinc-300">
          ...
          {onOpenInstallModal && (
            <button
              ...
              className="flex items-center gap-1 bg-gradient-to-r from-amber-500/20 to-cyan-500/20 hover:from-amber-500/30 hover:to-cyan-500/30 text-amber-300 hover:text-white border border-amber-500/40 px-2 py-0.5 rounded-lg text-[10px] sm:text-[11px] font-bold transition-all cursor-pointer shadow-sm active:scale-95"
        ...
        <div className="flex items-center gap-1.5 w-max">
          {onOpenInstallModal && (
            <button
              ...
              type="button"
              onClick={onOpenInstallModal}
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-gradient-to-r from-cyan-500/20 to-blue-500/20 text-cyan-300 border border-cyan-500/40 text-xs font-bold shadow-md cursor-pointer whitespace-nowrap active:scale-95 transition-transform shrink-0"
            >
