...
export const QUALITY_OPTIONS: QualityOption[] = [
  {
    ...
    shortLabel: '1080p',
    tag: 'Full HD',
    description: 'Хамгийн өндөр нягтаршил, тунгалаг дүрслэл (Max Bitrate, 60fps Crystal Clear)',
  ...
  },
  {
    ...
    shortLabel: '720p',
    tag: 'HD',
    description: 'Өндөр нягтаршил, хурдан ачаалалт (High Definition)',
    resolution: '1280x720',
  },
  {
    key: '480p',
    ...
    shortLabel: '480p',
    tag: 'SD',
    description: 'Стандарт чанар, дата хэмнэлтийн горим',
    resolution: '854x480',
  },
  {
    key: '360p',
    ...
    shortLabel: '360p',
    tag: 'Smooth',
    description: 'Сул интернетэд зориулсан хурдан тоглуулалт',
    resolution: '640x360',
  },
  {
    key: 'auto',
    ...
    shortLabel: 'Auto',
    tag: 'Автомат',
    description: 'Интернетийн хурдаас хамааран хамгийн сайн чанарыг сонгоно',
    resolution: 'Автомат',
  },
];
